<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CHR_request.aspx.cs" Inherits="GucAdvisingSystem.pages.Student.Requests.CHR_request" %>
...
<body>
    ...
    <form id="form1" runat="server">
     ...
     <div class="inputContainer">
         <h2>Send Credit hours Request</h2>
         <div class="inputGroup" id="credit_hours">
             <asp:TextBox ID="credit_hoursInput" runat="server" CssClass="input" placeholder="Credit Hours"></asp:TextBox>
             <asp:Label ID="CHR" runat="server" Text="Credit Hours " CssClass="userLabel"></asp:Label>
         </div>
         ...
         <div>
             <asp:Button ID="AddButton" OnClick="CHR_requested" runat="server"  Text="Send Request" class="AddButton"/>
         </div>
     </div>
        </div>
    </form>
