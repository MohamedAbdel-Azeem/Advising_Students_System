    ...
    public partial class SecondMakeup : System.Web.UI.Page
    {
        ...
        protected void Register(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand requestCourse = new SqlCommand("Procedures_StudentRegisterSecondMakeup", conn);
                ...
                SqlCommand log = new SqlCommand("Select dbo.FN_StudentCheckSMEligibility(@CourseID, @StudentID)", conn);
