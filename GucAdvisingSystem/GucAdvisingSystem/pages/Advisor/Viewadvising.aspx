<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewadvising.aspx.cs" Inherits="GucAdvisingSystem.pages.Advisor.Viewadvising" %>
...
<body>
    <aside style="background: linear-gradient(159deg, rgba(37,124,216,1) 0%, rgba(23,54,249,1) 100%); overflow:hidden" >
    <h1>Controls</h1>
    <div id="controls">
        <ul class="menu-list">
            <li>
