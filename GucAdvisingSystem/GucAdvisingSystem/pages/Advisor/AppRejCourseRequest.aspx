<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppRejCourseRequest.aspx.cs" Inherits="GucAdvisingSystem.pages.Advisor.ApprRejCourseRequest" %>
...
<body>
    ...
    <h2> Course Request</h2>
                       ...
                       <asp:TextBox ID="req" runat="server" placeholder="Request Id" CssClass="input"></asp:TextBox>
                            <asp:Label ID="studId" runat="server" Text="Request Id" CssClass="userLabel"></asp:Label>
                                                 </div>
              <asp:Button ID="Button9" runat="server" Text="Approve/reject" OnClick="ApprejreqC" CssClass="AddButton"/>
        </div>
        </div>
    </form>
