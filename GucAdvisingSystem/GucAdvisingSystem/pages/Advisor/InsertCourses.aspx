<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsertCourses.aspx.cs" Inherits="GucAdvisingSystem.pages.Advisor.InsertCourses" %>
    ...
    <form id="form1" runat="server">
        <div>
               <div class="inputContainer">
                  ...
                  <asp:TextBox ID="studentId1" runat="server" placeholder="Student Id" CssClass="input"></asp:TextBox>
                       <asp:Label ID="studId" runat="server" Text="Student Id" CssClass="userLabel"></asp:Label>
                       </div>
                     <div class="inputGroup">
                 <asp:TextBox ID="sem_code1" runat="server" placeholder="Semester Code" CssClass="input"></asp:TextBox>
                         <asp:Label ID="Label1" runat="server" Text="Semester Code" CssClass="userLabel"></asp:Label>
                         </div>
                   <div class="inputGroup">
                <asp:TextBox ID="course_name" runat="server" placeholder="Course Name" CssClass="input"></asp:TextBox>
                       <asp:Label ID="Label2" runat="server" Text="Course Name" CssClass="userLabel"></asp:Label>
                       </div>
                <asp:Button ID="Button6" runat="server" Text="Insert" OnClick="Insertcourses" CssClass="AddButton"/>
