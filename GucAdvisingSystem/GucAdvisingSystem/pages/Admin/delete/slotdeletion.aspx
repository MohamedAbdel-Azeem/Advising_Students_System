<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slotdeletion.aspx.cs" Inherits="Admin.slotdeletion" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Delete slot of a certain course if the course isn’t offered in the current semester.</title>
...
<body>
        ...
        <ul class="menu-list">
           ...
           <li class="menu-item">
            ...
            <li class="menu-item">
                ...
                <div class="content">
                    <p><a href="Delete.aspx" style="color:white;text-decoration:none">Course with its Slots</a></p>
                    <p><a href="slotdeletion.aspx" style="color:white;text-decoration:none">Not offered Course Slots</a></p>
                </div>
            </li>
            <li class="menu-item">
    ...
    <form id="form1" runat="server">
        <div class="inputContainer">
            <h2>Delete Semester's Slots</h2>
            <div class="inputGroup">
                <asp:DropDownList ID="slotdellist" runat="server" CssClass="input"></asp:DropDownList>
            </div>
            <div>
                <asp:Button ID="Button2" runat="server" OnClick="slotdelbut" Text="Delete Semester's slots" class="AddButton" Width="170px"/>
            </div>
        </div>
    </form>
